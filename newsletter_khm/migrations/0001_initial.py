    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ManyToManyField(default=newsletter_khm.utils.get_default_sites, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(verbose_name='message', to='newsletter_khm.Message')),
                ('newsletter', models.ForeignKey(editable=False, to='newsletter_khm.Newsletter', verbose_name='newsletter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_code', models.CharField(default=newsletter_khm.utils.make_activation_code, max_length=40, verbose_name='activation code')),
                ...
                ('newsletter', models.ForeignKey(verbose_name='newsletter', to='newsletter_khm.Newsletter')),
        ...
        migrations.AddField(
            ...
            name='subscriptions',
            field=models.ManyToManyField(help_text='If you select none, the system will automatically find the subscribers for you.', to='newsletter_khm.Subscription', db_index=True, verbose_name='recipients', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='message',
            name='newsletter',
            field=models.ForeignKey(verbose_name='newsletter', to='newsletter_khm.Newsletter'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='message',
        ...
        migrations.AddField(
            model_name='article',
            name='post',
            field=models.ForeignKey(related_name='articles', verbose_name='message', to='newsletter_khm.Message'),
            preserve_default=True,
        ),
    ]
