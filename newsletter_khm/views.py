...
class ActionUserView(ActionTemplateView):
    ...
    template_name = "newsletter_khm/subscription_%(action)s_user.html"
...
class ActionRequestView(ActionFormView):
    ...
    template_name = "newsletter_khm/subscription_%(action)s.html"
...
class UpdateSubscriptionView(ActionFormView):
    ...
    template_name = "newsletter_khm/subscription_activate.html"
