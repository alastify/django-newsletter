...
class SubmissionAdmin(admin.ModelAdmin, ExtendibleModelAdminMixin):
    ...
    def submit(self, request, object_id):
        ...
        if submission.sent or submission.prepared:
            ...
            change_url = reverse(
                'admin:newsletter_khm_submission_change', args=[object_id]
            )
        ...
        changelist_url = reverse('admin:newsletter_khm_submission_changelist')
...
class MessageAdmin(admin.ModelAdmin, ExtendibleModelAdminMixin):
    ...
    def preview(self, request, object_id):
        return render(
            request,
            "admin/newsletter_khm/message/preview.html",
    ...
    def submit(self, request, object_id):
        ...
        change_url = reverse(
            'admin:newsletter_khm_submission_change', args=[submission.id])
...
class SubscriptionAdmin(admin.ModelAdmin, ExtendibleModelAdminMixin):
    ...
    def subscribers_import(self, request):
        ...
        return render(
            request,
            "admin/newsletter_khm/subscription/importform.html",
            {'form': form},
        )
    ...
    def subscribers_import_confirm(self, request):
        ...
        return render(
            request,
            "admin/newsletter_khm/subscription/confirmimportform.html",
